...
public class NyttProduktController {
    ...
    public void addProdukt(){
        ...
        try {
            ...
            statement.execute("INSERT INTO product(product_id, product_name, description, price, category) VALUES ('" +
                    produktId.getText() + "', '" +  produktNavn.getText() + "' , '" + beskrivelse.getText() + "', '" + pris.getText()  + "', '" + kategori.getText() + "');");
            statement.close();
            conn.close();
