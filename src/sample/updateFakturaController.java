...
public class updateFakturaController {
    ...
    public void updateKunde(){
        ...
        try {
            ...
            statement.execute("UPDATE invoice SET customer = '" +
                    kunde.getText() + "' "+ "WHERE invoice_id = " + "'" + fakturaId.getText() + "';");
            statement.close();
            conn.close();
    ...
    public void updateDato(){
        ...
        try {
            conn = DriverManager.getConnection(url);
            Statement statement = conn.createStatement();
            statement.execute("UPDATE invoice SET dato = '" +
                    dato.getText() + "' "+ "WHERE invoice_id = " + "'" + fakturaId.getText() + "';");
            statement.close();
            conn.close();
        }catch (SQLException e) {
            System.out.println(e.getMessage());
